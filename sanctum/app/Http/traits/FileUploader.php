...
trait FileUploader
{
     ...
     * @return bool|string
     */
    public function uploadImagePublic ($request, $data, $name, $inputName = 'profile')
    {
        $requestFile = $request->file($inputName);
        //$requestFile = $data->file($inputName);
        try {
    ...
    public function uploadImagePrivate($request, $data='null', $name, $inputName = 'identity_img')
    {
        $requestFile = $request->file($inputName);
